...
namespace DodavanjeBaterije
{
    public partial class dodavanjeBaterijeForm : Form
    {
        ...
        private void baterijaDodajButton_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Pogresan unos kapaciteta!", "GRESKA", MessageBoxButtons.OK);
            }
            ...
            else
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    {
                        MessageBox.Show("Nemoguce dodati bateriju sa tim imenom!", "Greska!", MessageBoxButtons.OK);
                        textBoxIme.Text = "";
                        textBoxSnaga.Text = "";
                        textBoxKapacitet.Text = "";
                    }
